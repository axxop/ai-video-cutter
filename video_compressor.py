...
- good (70-89): 内容相关，画面合适，总时长符合要求
- acceptable (50-69): 内容部分相关，总时长刚好够用
- poor (30-49): 内容勉强相关 **或 总时长不在范围内**（会卡顿或被截断）
- none (0-29): 几乎无相关内容或总时长严重不符

**⚠️ 重要**: 
- 如果总时长 < {min_duration:.1f}秒 → 评分最高只能是 poor！
- 如果总时长 > {max_duration:.1f}秒 → 会被截断浪费，评分也会降低！
...
{{
  ...
  "content_match": "精确匹配基德预告信场景，总时长符合要求",
  "issues": []
}}
"""
